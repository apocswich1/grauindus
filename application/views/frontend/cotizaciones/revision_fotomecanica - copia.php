   ...
   <div class="control-group">
    ...
    <div class="control-group" id="hacer_troquel" style="display: block;">
		...
		<div class="controls">
            ...
            <div id="molde_select" style="display:  <?php if($ing->estan_los_moldes=="SI" and $datos->condicion_del_producto==""){echo 'block';}else{echo 'none';}?>;">
                <?php
		...
		<span id="div_moldes"></span>
            ...
            <div id="molde_select" style="display:  <?php if($ing->estan_los_moldes=="SI" and $datos->condicion_del_producto!="Nuevo" and $datos->condicion_del_producto!=""){echo 'block';}else{echo 'none';}?>;">
		...
		<div id="molde_select" style="display:  <?php if($ing->estan_los_moldes=="SI" and $Detalle_Molde->tipo=="Genérico" and $datos->condicion_del_producto!=""){echo 'block';}else{echo 'none';}?>;">
            <!--<select name="molde" onchange="carga_ajax5('<?php //echo base_url();?>moldes/detalle_ajax',this.value,'div_moldes');" disabled>-->
                <?php
                $moldes=$this->moldes_model->getMoldes();
                foreach($moldes as $molde)
...
//                }
                    ?>
                    <div id="cuno2_proceso" style="display:<?php if($fotomecanica->cuno2_proceso_seletec==''){echo 'none';}else{echo 'block';}?>;"><strong>&nbsp;Proceso Especial:&nbsp; </strong>                          
