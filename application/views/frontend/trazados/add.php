...
padding-left: 70px;">Rango de gramaje de la cartulina para casos contra la fibra</label>
		...
		<div class="controls">
				<select name="rango_gramaje" id="rango_gramaje">
...
<div class="control-group">
    ...
    <div class="control-group" id="producto">
		...
		<div class="controls">
			<input type="text" id="anchobobina" name="ancho_bobina" style="width: 100px;" value="<?php echo set_value("ancho_bobina") ?>" placeholder="Ancho" /> X <input type="text" name="largo_bobina" id="largobobina" style="width: 100px;" value="<?php echo set_value('largo_bobina') ?>" placeholder="Largo" /> 
		</div>
	</div>
