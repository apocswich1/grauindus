   ...
   <!-- /Migas -->
	<div class="page-header"><h3>Solicitud de Cotización </h3></div>
     ...
     <div class="control-group">
		...
		<div class="controls">
			<select name="cliente" class="chosen-select" style="width: 500px;">
...
-->
   ...
   <!--productos asociados--> 
    ...
    <div class="control-group" id="estan_los_moldes" style="display: block;">
		...
		<div class="controls">
			<select name="estan_los_moldes1" style="width: 100px;" onchange="estanLosMoldes(this.value);condicionParaMoldesGenericos(this.value);">
	  ...
	  <div class="control-group" id="estan_los_moldes_generico" style="display: none;">
		<label class="control-label" for="usuario">Moldes Genéricos</label>
		<div class="controls">
			<select name="estan_los_moldes" style="width: 100px;" onchange="estanLosMoldes(this.value);condicionParaMoldesGenericos(this.value);">
                <option value="SI" <?php if(isset($_POST["estan_los_moldes"]) and $_POST["estan_los_moldes"]=='SI'){echo 'selected="selected"';}?>>SI</option> 
				<option value="NO" <?php if(isset($_POST["estan_los_moldes"]) and $_POST["estan_los_moldes"]=='NO'){echo 'selected="selected"';}?>>NO</option>
            </select> 
            <div id="molde_select" style="display: none;">
     ...
     <div class="control-group">
		...
		<div class="controls">
			<select name="forma_pago">
                ...
                {
                    ?>
                    <option value="<?php echo $forma->forma_pago?>" <?php if($cliente_forma_pago_id->id_forma_pago==$forma->id){echo 'selected="selected"';}?>><?php echo $forma->forma_pago?></option>
                    <?php
                }
                ?>
